...
from Utils.time_control import now_time
from Utils.get_local_host import get_host_ip
from Utils.exceptions import SendMessageError, ValueTypeError
...
if __name__ == '__main__':
    ...
    # WeChatSend(AllureFileClean().get_case_count()).send_text(content='test_data',mentioned_mobile_list=['@all'])
    WeChatSend(AllureFileClean().get_case_count()).send_file_msg('../github 封面图.png')